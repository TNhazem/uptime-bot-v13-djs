  ...
  run: async (client, interaction, args) => {
    ...
    if (checkIfExsists === null) {
      ...
      await UrlsConfig.create({
        ...
        await interactionA.edit({ embeds: [new MessageEmbed().setTitle(" <a:yes:962966293764505620> Added Succesfully").setColor("RED").setDescription("Thanks for using me").setTimestamp()] });
